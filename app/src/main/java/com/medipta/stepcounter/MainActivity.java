...
public class MainActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment implements FStepService.StepCountListener {
        ...
        private TextView mTxtStepsCount, mTxtStepsDetectedCount, mTxtStepEvent,mTxtDistance;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            mTxtDistance=rootView.findViewById(R.id.txtDistance);
        ...
        public void onStepDataUpdate(int stepCount) {
            ...
            mTxtDistance.setText(String.valueOf("Distance walked : "+getDistanceRun(stepCount)+" km"));
        }
